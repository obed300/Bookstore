...
**Bookstore** is a website that allow users to add and remove a book.
...
https://github.com/obed300/Bookstore.git
...
```sh
  cd Bookstore
  git clone https://github.com/obed300/Bookstore.git
```
